        ...
        if (xmlhttp.status == 200)
        {
            ...
            for (i in canvases)
            {
                if (canvases[i].creatorId == currentUser.id || CheckUserAllowance(users, canvases[i]))
                {
                    ...
                    x += "<tr><td class=\"col-md-2\">" + canvases[i].id + "<\/td>" + "<td class=\"col-md-2\">" + canvases[i].name + "<\/td>" + "<td class=\"col-md-2\">" + canvases[i].creatorId + "<\/td>" + "<td class=\"col-md-2\">" + "<a href=\"\/canvas.html?id=" + canvases[i].id + "\">Ссылка<\/a>" + "<\/td>" + "<td>" + star + "<\/td>" + "<td> <button onclick=\"Delete(" + canvases[i].id + ");\">Удалить<\/button><\/td>" + "<\/tr>";
